...
export const LoginForm = (props: LoginProps) => {
	...
	const passwordIcon = () => {
		if (showPassword == 0) {
			return (
				<EyeFill className="cursor" onClick={() => switchShowPassword()} />
			);
		} else {
	...
	const validButton = () => {
		if (props.isLoading) {
			return (
				<div className="py-2 px-md-0 col-md-5 m-md-0 px-4 col-6 me-2 text-center connectionText disabled">
					Je me connecte
				</div>
			);
		} else {
			return (
				<div
					className="py-2 px-md-0 col-md-5 m-md-0 px-4 col-6 me-2 text-center connectionText"
	...
	return (
		<div className="p-md-5 pb-4 loginContainer col-xl-5 col-lg-7 col-md-10 col-12">
			...
			<div className="buttonContainer d-flex align-items-center justify-content-between mt-md-4 mt-3">
				{validButton()}
				<div className="p-2 text-dark col-md-6 col-6 ms-2 text-center passwordText px-0 ">
					MOT DE PASSE OUBLIÉ
				</div>
			</div>
			...
			<div className="buttonContainer notMember d-flex mt-md-4 mt-1">
				...
				<p
					...
					className="fw-md-bold passwordText"
				>
					Créer un compte.
				</p>
			</div>
