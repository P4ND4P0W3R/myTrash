    ...
    return (
        <>
            <nav className="navbar">
                <NavLink className="mytrash-logo" to="/">My Trash</NavLink>
                <div className={`nav-links ${isMobileMenuOpen ? 'mobile-menu' : ''}`}>
                    <ul>
                        ...
                        <li><NavLink className="nav-link" to="/Find" onClick={closeMobileMenu}>Find out more</NavLink></li>
                        <li><NavLink className="nav-link" to="/login" onClick={closeMobileMenu}>Login</NavLink></li>
                        <li><NavLink className="nav-link" to="/register" onClick={closeMobileMenu}>Register</NavLink></li>
                    </ul>
                </div>
